...
package com.juxun.business.street.zxing.view;
...
public final class ViewfinderView extends View {
	...
	public void drawViewfinder(CameraManager cameraManager, int minW, int minH,
			int maxW, int maxH) {
		isSelected = true;
		resultBitmap = null;
		cameraManager.setInchs(minW, minH, maxW, maxH);
		invalidate();
	}
