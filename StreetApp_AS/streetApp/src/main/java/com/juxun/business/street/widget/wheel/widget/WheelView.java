...
package com.juxun.business.street.widget.wheel.widget;

import java.util.LinkedList;
import java.util.List;

import com.juxun.business.street.widget.wheel.widget.adapter.WheelViewAdapter;
...
//					R.drawable.com_ttshrk_view_scroll_picker_bar);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		/*
		 * / Remarked by wulianghuan 2014-11-27 娴ｈ法鏁ら懛顏勭箒閻ㄥ嫮鏁剧痪鍖＄礉閼板奔绗夐弰顖涘伎閿燂拷
		...
		paint.setColor(getResources().getColor(R.color.dialog_title_color));
		// 鐠佸墽鐤嗙痪鍨啍
