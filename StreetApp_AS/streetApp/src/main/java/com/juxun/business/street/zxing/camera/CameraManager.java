...
package com.juxun.business.street.zxing.camera;
...
public final class CameraManager {
	...
	private int MAX_FRAME_WIDTH = 540;
	private int MAX_FRAME_HEIGHT = 540;

	public void setInchs(int minW, int minH, int maxW, int maxH) {
