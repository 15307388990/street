    ...
    private void initView() {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(SearchWebviewActivity.this, SupplierGoodsInfoActivity.class);
        ...
        et_search.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEND
                    ...
                    commodity_name = et_search.getText().toString();
                    getSupplierCommodityList();
                    // 关闭软键盘
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.rl_shopcart:
                intent.setClass(SearchWebviewActivity.this, ShoppingCartActivity.class);
                startActivity(intent);
                break;
        }
    }
