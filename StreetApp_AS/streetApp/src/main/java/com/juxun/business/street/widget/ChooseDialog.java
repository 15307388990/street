...
public class ChooseDialog extends PopupWindow implements OnClickListener {
	...
	public ChooseDialog(Context context, onConfirmListener listener) {
		super(context);
		mContext = context;
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.choose_dialog, null);
