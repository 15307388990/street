...
import com.juxun.business.street.activity.BusinessToDayAcitivity;
...
public class BusinessAdapter extends BaseAdapter {
	...
	public BusinessAdapter(Context mContext, List<Analysisbean> list) {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.business_itm,
					null);
		...
		viewHolder.tv_date
				.setText(siFormat.format(analysisbean.getOrder_date()));
		viewHolder.tv_state.setText("" + analysisbean.getOrder_cost()/100);
