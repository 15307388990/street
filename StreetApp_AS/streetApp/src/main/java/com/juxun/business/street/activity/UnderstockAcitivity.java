...
/**
 * 
 * 类名称：UnderstockAcitivity 类描述：库存不足的商品 创建人：罗富贵 创建时间：2016年10月11日
 * 
 * @version
 * 
 */
public class UnderstockAcitivity extends BaseActivity implements ChooseDialog4.onConfirmListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_understock);
	...
	private void initView() {
		...
		mListview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				if (arg2 >= 1) {
					ChooseDialog4 chooseDialog = new ChooseDialog4(getApplicationContext(), UnderstockAcitivity.this);
					chooseDialog.showAtLocation(button_function, Gravity.BOTTOM, 0, 0);
					mCommodityInfoBean = mCommdity.get(arg2 - 1);
				}
			}
		});
		tishiView = LayoutInflater.from(this).inflate(R.layout.ll_tishi, null);
	...
	public void onConfirm(int id) {
		...
		case R.id.ll_checkdetails:
			intent.setClass(UnderstockAcitivity.this, CheckdetailsAcitivity.class);
		...
		case R.id.ll_amend_shelflife:
			intent.setClass(UnderstockAcitivity.this, AmendShekflifeAcitivity.class);
			startActivity(intent);
			break;
		// 商品下架
		case R.id.ll_soldout:
			AlertDialog.Builder builder = new Builder(UnderstockAcitivity.this);
