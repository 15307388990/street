...
public class DetailsDialog3 extends PopupWindow implements OnClickListener {
	...
	public DetailsDialog3(Context context, onConfirmListener listener) {
		super(context);
		mContext = context;
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.details_dialog3, null);
