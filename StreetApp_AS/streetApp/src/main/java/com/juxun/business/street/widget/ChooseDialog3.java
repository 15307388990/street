...
public class ChooseDialog3 extends PopupWindow implements OnClickListener {
	...
	public ChooseDialog3(Context context, onConfirmListener listener) {
		super(context);
		mContext = context;
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.choose_dialog3, null);
