...
/**
 * 
 * @author PromptDialog 提示弹框
 *
 */
public class PromptDialog extends PopupWindow implements OnClickListener {
	...
	public PromptDialog(Context context) {
		...
		mMenuView = inflater.inflate(R.layout.prompt_dialog, null);
