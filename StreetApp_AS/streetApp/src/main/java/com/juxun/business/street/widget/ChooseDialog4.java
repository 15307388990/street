...
public class ChooseDialog4 extends PopupWindow implements OnClickListener {
	...
	public ChooseDialog4(Context context, onConfirmListener listener) {
		super(context);
		mContext = context;
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.choose_dialog4, null);
	...
	private void setUpViews() {
		// ll_amend_message = (LinearLayout)
		// mMenuView.findViewById(R.id.ll_amend_message);
		ll_checkdetails = (LinearLayout) mMenuView.findViewById(R.id.ll_checkdetails);
		ll_amend_shelflife = (LinearLayout) mMenuView.findViewById(R.id.ll_amend_shelflife);
		...
		// btn_amend_message = (Button)
		// mMenuView.findViewById(R.id.btn_amend_message);
		btn_checkdetails = (Button) mMenuView.findViewById(R.id.btn_checkdetails);
		btn_amend_shelflife = (Button) mMenuView.findViewById(R.id.btn_amend_shelflife);
