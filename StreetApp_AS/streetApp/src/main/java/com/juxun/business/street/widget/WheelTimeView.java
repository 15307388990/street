 ...
 */
public class WheelTimeView extends ScrollView {
	public static final String TAG = WheelTimeView.class.getSimpleName();
	...
	int offset = OFF_SET_DEFAULT; // ���绉婚��锛����瑕���ㄦ�������㈠����������㈣ˉ���锛�
	...
	int displayItemCount; // 姣�椤垫�剧ず�����伴��
				...
				if (initialY - newY == 0) { // stopped
					...
					if (remainder == 0) {
						...
						if (remainder > itemHeight / 2) {
							WheelTimeView.this.post(new Runnable() {
								@Override
								public void run() {
									WheelTimeView.this.smoothScrollTo(0, initialY
					...
					initialY = getScrollY();
					WheelTimeView.this.postDelayed(scrollerTask, newCheck);
				}
			}
		};
	...
	public void setSeletion(int position) {
		...
		this.post(new Runnable() {
			@Override
			public void run() {
				WheelTimeView.this.smoothScrollTo(0, p * itemHeight);
			}
		});
