...
import com.ming.ui.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            Log.d("pull-to-refresh", "action move"+"deltaY"+deltaY);
            final float absDiff = Math.abs(deltaY);
            Log.d("pull-to-refresh", "action move"+"absDiff"+absDiff);
            Log.d("pull-to-refresh", "action move"+"mTouchSlop"+mTouchSlop);
            // 这里有三个条件：
            ...
            Log.d("pull-to-refresh", "action move"+"mIsHandledTouchEvent"+mIsHandledTouchEvent);
            break; 
    ...
    public void doPullRefreshing(final boolean smoothScroll, final long delayMillis) {
        postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                startRefreshing();
                smoothScrollTo(newScrollValue, duration, SCROLL_DURATION);
            }
        }, delayMillis);
    }
